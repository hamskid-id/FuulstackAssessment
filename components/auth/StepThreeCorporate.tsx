...
export const StepThreeCorporate: React.FC<IStepThreeCorporate> = ({
  setActiveStep,
}) => {
      ...
      <Form {...form}>
        ...
        >
          <div className="w-full">
            ...
            >{`Enter the 4-digit code that was sent to name@gmail.com`}</Text>
          </div>
          <FormInputField
          ...
          <div className="flex flex-col gap-4 w-full mb-[100px]">
            <Text
              style={`cursor-pointer text-[grey] ${FontSize.sm} leading-[21px] font-[400]`}
            >
              Resend Code
            </Text>
            <Text
